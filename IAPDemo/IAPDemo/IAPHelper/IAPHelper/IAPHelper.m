...
- (void)buyProduct:(SKProduct *)productIdentifier applicationUsername:(NSString *)applicationUsername onCompletion:(IAPbuyProductCompleteResponseBlock)completion;
{
    self.buyProductCompleteBlock = completion;
...
// 未校验的Receipt
- (void)checkNotVerifyReceiptReceipt:(NSData*)receiptData onCompletion:(checkReceiptCompleteResponseBlock)completion
{
    ...
    if(_checkReceiptCompleteBlock) {
        _checkReceiptCompleteBlock(receiptBase64,nil);
    }
}
